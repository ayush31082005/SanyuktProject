...
const BusinessOpportunity = ({ businessHighlights, businessImage, handleNavigation }) => {
    return (
        <section className="py-10 md:py-16 bg-[#0D0D0D] text-white relative overflow-hidden border-y border-[#C8A96A]/10" >
            <div className="container mx-auto px-4 max-w-5xl">
                <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
                    ...
                    <div className="relative luxury-box p-1 h-fit">
                        <img src={businessImage} alt="Business Opportunity" className="w-full h-auto max-h-[300px] object-cover" />
