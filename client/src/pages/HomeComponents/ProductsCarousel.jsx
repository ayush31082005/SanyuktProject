                    ...
                    {loading ? (
                        ...
                        [1, 2, 3, 4, 5].map((i) => (
                            <div key={i} className="min-w-[200px] sm:min-w-[220px] md:min-w-[240px] snap-center">
                                <div className="luxury-box overflow-hidden border-[#C8A96A]/10 bg-[#1A1A1A]/30">
                                    <div className="h-32 w-full shimmer" />
                                    <div className="p-3.5 space-y-3">
                                        <div className="flex gap-1">
                                            {[1, 2, 3, 4, 5].map(s => <div key={s} className="w-3 h-3 rounded-full bg-[#C8A96A]/10" />)}
                                        </div>
                                        <div className="space-y-2">
                                            <div className="h-4 w-3/4 skeleton-box shimmer" />
                                            <div className="h-3 w-1/2 skeleton-box shimmer" />
                                        </div>
                                        <div className="flex justify-between items-end pt-2">
                                            <div className="space-y-1">
                                                <div className="h-5 w-12 skeleton-box shimmer" />
                                                <div className="h-3 w-16 skeleton-box shimmer" />
                                            </div>
                                            <div className="h-6 w-10 skeleton-box shimmer rounded-lg" />
                                        </div>
                                        <div className="pt-2">
                                            <div className="h-9 w-full skeleton-box shimmer" />
                                        </div>
                                    </div>
                                </div>
                            </div>
