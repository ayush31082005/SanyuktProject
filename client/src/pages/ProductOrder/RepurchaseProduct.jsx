...
export default function RepurchaseProductPage() {
    ...
    const handleOrder = async (e) => {
        ...
        try {
            const { data } = await api.post('/repurchase/place', {
                directSellerId,
                cart,
                payFrom,
                orderTo,
    ...
    return (
        <div className="min-h-screen bg-[#0D0D0D] px-4 py-6 md:px-6">
            ...
            <div className="order-theme mx-auto max-w-[1280px] space-y-6">
                <SectionCard icon={PackagePlus} title="Add Repurchase Products">
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            >
                                <option value="">{productsLoading ? 'Loading products...' : '--Select Repurchase Products--'}</option>
                ...
                <SectionCard icon={Receipt} title="Repurchase Billing Details">
                ...
                <SectionCard icon={ShoppingBag} title="Place Repurchase Order">
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div>
                                ...
                                <select value={payFrom} onChange={(e) => setPayFrom(e.target.value)} className={fieldClass}>
                                    ...
                                    <option value="repurchase-wallet">Repurchase Wallet</option>
