...
const WelcomeLetter = () => {
    ...
    return (
        <div className="mx-auto max-w-5xl bg-[#0D0D0D] px-4 py-6 md:px-6 min-h-screen">
            ...
            <div className="mx-auto max-w-4xl border border-[#C8A96A]/20 bg-[#1A1A1A] px-8 py-10 shadow-2xl shadow-[#C8A96A]/5 print:border-none print:shadow-none print:bg-white md:px-14 md:py-14 rounded-2xl print:rounded-none">
                <div className="border-b border-[#C8A96A]/20 print:border-black/20 pb-6">
                    <div className="text-center">
                        ...
                        <p className="mt-2 text-sm text-[#C8A96A]/80 font-bold uppercase tracking-widest print:text-gray-600">Welcome Letter</p>
                    </div>
                </div>

                <div className="pt-8 text-[15px] leading-8 text-[#F5E6C8] print:text-black">
                    <div className="mb-8 flex flex-col gap-4 text-sm md:flex-row md:items-start md:justify-between">
                        <div className="bg-[#0D0D0D] print:bg-transparent p-4 rounded-xl border border-[#C8A96A]/10 print:border-none print:p-0">
                            <p><span className="font-bold text-[#C8A96A] print:text-gray-800 uppercase text-[11px] tracking-widest mr-2">Name:</span> 
                               <span className="font-semibold text-[15px]">{userData?.userName || 'Member'}</span></p>
                            <p className="mt-1"><span className="font-bold text-[#C8A96A] print:text-gray-800 uppercase text-[11px] tracking-widest mr-2">Member ID:</span> 
                        ...
                        <div className="text-left md:text-right bg-[#0D0D0D] print:bg-transparent p-4 rounded-xl border border-[#C8A96A]/10 print:border-none print:p-0">
                            <p><span className="font-bold text-[#C8A96A] print:text-gray-800 uppercase text-[11px] tracking-widest mr-2">Date:</span> 
                    ...
                    <div className="px-2 md:px-4">
                        ...
                        <p className="mb-5 text-[#F5E6C8]/90 print:text-gray-800 leading-relaxed">
                        ...
                        <p className="mb-10 text-[#F5E6C8]/90 print:text-gray-800 leading-relaxed">
                        ...
                        <div className="mt-12 border-t border-[#C8A96A]/20 print:border-black/20 pt-8">
                            <p className="text-[#C8A96A]/80 print:text-gray-600 font-semibold mb-8 uppercase tracking-widest text-[11px]">Yours sincerely,</p>
                            <p className="font-bold text-[#F5E6C8] print:text-black text-lg">Authorized Signatory</p>
                            <p className="text-[#C8A96A] print:text-gray-800 font-serif mt-1">Sanyukt Parivaar & Rich Life Pvt.Ltd.</p>
                        </div>
                    </div>
                </div>
            </div>
