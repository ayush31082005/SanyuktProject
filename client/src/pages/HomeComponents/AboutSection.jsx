    ...
    return (
        <section className="py-2 bg-[#0D0D0D] relative overflow-hidden">
            <div className="container mx-auto px-4">
                ...
                <div className="grid md:grid-cols-2 gap-2 md:gap-4 items-center max-w-5xl mx-auto">
                    <div className="space-y-1.5 text-gray-700 order-2 md:order-1 flex flex-col justify-center">
                        <h3 className="text-md md:text-xl font-serif font-bold text-[#F5E6C8] mb-1 leading-tight uppercase tracking-tight">
                            Sanyukt Parivaar & <br />
                            <span className="text-[#C8A96A]">Rich Life Pvt.Ltd.</span>
                        </h3>
                        <p className="text-xs text-[#F5E6C8]/70 font-light leading-relaxed">
                    ...
                    <div className="relative order-1 md:order-2 luxury-box p-1">
                        <img src={aboutImage} alt="About Us" className="w-full h-auto max-h-[180px] object-cover" />
